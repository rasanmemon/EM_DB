...
<tr>
    ...
    <?php 
		...
		$name =$_POST['sviewlist'];
	
		$conn = mysqli_connect($servername, $username, $password, $dbname);
		$read_event = "SELECT * FROM  guest INNER JOIN weakentity ON weakentity.EventID = $name AND weakentity.Guest_Id = guest.Guest_Id ";
